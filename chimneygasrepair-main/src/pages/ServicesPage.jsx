...
export default function ServicesPage() {
  useDocumentMeta({
    title: 'Services',
    description: 'Gas stove, hob, cooktop, burner and kitchen chimney repair, cleaning and maintenance services.',
  });
  ...
  return (
    <>
      <PageHero
        ...
        title="Focused care for gas appliances and kitchen chimneys."
        description="From weak burner flames to poor chimney suction, each category follows the same diagnosis-first approach."
        image="/images/chimney-hero.webp"
      />
